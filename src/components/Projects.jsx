...
const Projects = () => {
  return (
    ...
    <div class="card">
    <div class="title"><img className = "project-img" src={P1}/></div>
  <div class="icon">
  ...
  <a href="https://shweta-chat-app.web.app/" class="btn">Check it out</a>

</div>

<div class="card">

  <div class="title"><img className = "project-img" src={P2}/></div>
...
<div class="card">
   ...
   <div class="title"><img className = "project-img" src={P3}/></div>
